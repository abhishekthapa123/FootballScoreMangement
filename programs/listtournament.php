      ...
      <?php include('adminnavbar.php');?>
        ...
        // output data of each row
           ...
           <tr>
                            ...
                            <td><a href="viewscores.php?tid=<?php echo $row['id'];?>">  <button class="btn btn-danger" type="submit">View</button> </a></td>
                            <td><a href="feedbackform.php?tid=<?php echo $row['id'];?>">  <button class="btn btn-warning" type="submit"> Give Feedback</button> </a></td>
